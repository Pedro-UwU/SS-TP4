...
public class Ejercicio2_1 {
    ...
    public static void main(String[] args) {
        double v0 = 5e4;
        Config.readConfig();
        double dt[] = {1E-16, 1E-17, 1E-18, 1E-19, 1E-20, 1E-21};
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for(int j = 0 ; j < dt.length ; j++){
                ...
                for(int k = 0 ; k < RUNS_EACH ; k++ ){
                    ...
                    Radiation.run( (int)(1000) , Config.TOTAL_T , delta_t, Config.N, Config.D, Config.Q, Config.MASS, Config.K, v0, v0, Config.getIntegration(), initPos, new OutputManager(filename)  );
                }
            }
